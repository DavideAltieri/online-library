...
Per quanto riguarda l'applicazione, è stato utilizzato un pattern MVC (con Spring):
	-Model: rappresenta la logica dei dati dell'applicazione. In questo caso, la classe "Libro" rientra in questa categoria, rappresenta i dati relativi ai libri (ad esempio: titolo, autore, genere e anno di rilascio).
